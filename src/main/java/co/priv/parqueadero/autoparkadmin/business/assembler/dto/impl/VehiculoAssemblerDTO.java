...
public class VehiculoAssemblerDTO implements AssemblerDTO<VehiculoDomain, VehiculoDTO>{
	...
	private static final AssemblerDTO<VehiculoDomain, VehiculoDTO> instance =
			new VehiculoAssemblerDTO();
	...
	public List<VehiculoDomain> toDomainCollection(List<VehiculoDTO> dtoCollection) {
		var dtoCollectionTmp = ObjectHelper.getObjectHelper().getDefaultValue(dtoCollection, new ArrayList<VehiculoDTO>());
